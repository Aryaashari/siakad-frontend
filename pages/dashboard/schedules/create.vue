  ...
  <div class="p-6">
    <div class="mb-6">
      <div class="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 class="text-3xl font-bold text-gray-900">Tambah Jadwal Pelajaran</h1>
          <p class="text-gray-600 mt-1">Buat jadwal pelajaran baru</p>
        </div>
      </div>
    </div>
...
const handleSubmit = async () => {
  try {
    ...
    if (error.data?.message?.includes('conflict')) {
      ...
      toast.error(error.data?.message || 'Gagal menambahkan jadwal')
    }
  } finally {
